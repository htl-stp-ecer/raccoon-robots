...
from src.missions.m040_collect_botguy_mission import M040CollectBotguyMission
...
class Robot(GenericRobot):
    ...
    width_cm = 23.5
    length_cm = 26
    rotation_center_forward_cm = 0.5
    rotation_center_strafe_cm = 0.0
    _sensor_positions = {
        defs.rear_left_light_sensor: SensorPosition(
            forward_cm=-11.2, strafe_cm=10.75, clearance_cm=0
        ),
        defs.front_right_light_sensor: SensorPosition(
            forward_cm=11.7, strafe_cm=-10.75, clearance_cm=0
        ),
        defs.front_left_light_sensor: SensorPosition(
            forward_cm=10.8, strafe_cm=2.25, clearance_cm=0
        ),
    }
    _wheel_positions = {
