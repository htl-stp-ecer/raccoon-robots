...
class Robot(GenericRobot):
    ...
    odometry = FusedOdometry(
        imu=defs.imu, kinematics=kinematics, config={"bemf_trust": 1.0}
    )
    motion_pid_config = UnifiedMotionPidConfig(
        ...
        linear={"max_velocity": 0.2139, "acceleration": 0.9402, "deceleration": 1.6644},
        lateral={
            "max_velocity": 0.2209,
            "acceleration": 0.6485,
            "deceleration": 0.4498,
        },
        angular={"max_velocity": 2.34, "acceleration": 9.1, "deceleration": 20},
    )
    shutdown_in = 120
    missions = [
